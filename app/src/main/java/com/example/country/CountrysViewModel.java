...
public class CountrysViewModel extends ViewModel {
    MutableLiveData<List<Country>> countrys = new MutableLiveData<>();
    public CountrysViewModel() {
    }

    public MutableLiveData<List<Country>> getCountrys() {
        ...
        countrys.setValue(countries);
        return countrys;
    }

    public void setCountrys(MutableLiveData<List<Country>> countrys) {
